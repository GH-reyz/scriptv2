...
cd /usr/bin
wget -O mss "https://raw.githubusercontent.com/GH-reyz/scriptv2/main/mss.sh"
wget -O add-ss "https://raw.githubusercontent.com/GH-reyz/scriptv2/main/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/GH-reyz/scriptv2/main/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/GH-reyz/scriptv2/main/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/GH-reyz/scriptv2/main/renew-ss.sh"
chmod +x mss
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
