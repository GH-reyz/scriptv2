...
VALIDITY () {
    ...
    Exp1=$(curl https://raw.githubusercontent.com/GH-reyz/registerv3/main/register%20ip | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl https://raw.githubusercontent.com/GH-reyz/registerv3/main/register%20ip | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
